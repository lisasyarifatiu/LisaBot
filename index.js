...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN ASU!?
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6285641345088:+62 856@4134-5088\n' // GANTI NOMOR LU
            + 'END:VCARD'
prefix = '/'
blocked = []
...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6285641345088@s.whatsapp.net"] // GANTI NOMOR LU
			const adminbotnumber = ["1(978)4440044@s.whatsapp.net"] // GANTI NOMOR LU
			const frendsowner = ["6288706650883@s.whatsapp.net"] // GAUSAH DIGANTI!!!
			...
			case 'owner':
               ...
               case 'infogempa':
			    ...
			    case 'otagall':
					...
					mentions('╔══✪〘 Mention All 〙✪══'+teks+'╚═〘 YOKS BOT 〙', members_id, true)
					break
				case 'clearall':
					if (!isOwner) return reply('Kamu siapa?')
				...
				case `addadmin`:
                   ...
                   reply('Success Menambahkan Admin Yoks!')
				   }
                   break
				case 'wait':
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
